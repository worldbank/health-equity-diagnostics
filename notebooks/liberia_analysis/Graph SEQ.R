...
rwi_path <- 'P:/Data/PROJECTS/Health/output/LBR/test_rwi.csv'

rwi <- read.csv(rwi_path) 
# %>%
#    filter(WB_ADM2_NA=="Barrobo")
...
health_rwi
ggsave("Access to Health by RWI.jpeg", width = 8, height = 6)

hospital_rwi
ggsave("Access to Hospital by RWI.jpeg", width = 8, height = 6)
